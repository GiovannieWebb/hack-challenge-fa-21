...
class IngredientPopUp: UIView {
    ...
    let ingredName: UITextField = {
       let label = UITextField()
       label.translatesAutoresizingMaskIntoConstraints = false
       label.placeholder = "Apple Slices"
...
//            selected = false
    ...
    let container: UIView = {
     ...
     lazy var stack: UIStackView = {
        let stack = UIStackView(arrangedSubviews: [titleLabel, nameLabel, amountLabel])
...
//        self.backgroundColor = .darkGray
        ...
        self.addSubview(ingredName)
        self.addSubview(ingredUnit)
...
//        container.widthAnchor.constraint(equalToConstant: 375).isActive = true
        container.heightAnchor.constraint(equalToConstant: 259).isActive = true
        ...
        nameLabel.leadingAnchor.constraint(equalTo: container.leadingAnchor, constant: 74).isActive = true
        nameLabel.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: 29).isActive = true
        ...
        amountLabel.leadingAnchor.constraint(equalTo: container.leadingAnchor, constant: 74).isActive = true
        amountLabel.topAnchor.constraint(equalTo: nameLabel.bottomAnchor, constant: 31).isActive = true
        
        ingredName.widthAnchor.constraint(equalToConstant: 174).isActive = true
        ingredName.heightAnchor.constraint(equalToConstant: 21).isActive = true
        ingredName.leadingAnchor.constraint(equalTo: nameLabel.trailingAnchor, constant: 16).isActive = true
        ingredName.topAnchor.constraint(equalTo: nameLabel.topAnchor).isActive = true
        
        ingredUnit.widthAnchor.constraint(equalToConstant: 174).isActive = true
        ingredUnit.heightAnchor.constraint(equalToConstant: 21).isActive = true
        ingredUnit.leadingAnchor.constraint(equalTo: nameLabel.trailingAnchor, constant: 16).isActive = true
        ingredUnit.topAnchor.constraint(equalTo: amountLabel.topAnchor).isActive = true
        ...
        addButton.bottomAnchor.constraint(equalTo: container.bottomAnchor, constant: -30).isActive = true
        ...
        exitButton.topAnchor.constraint(equalTo: nameLabel.topAnchor).isActive = true
